...
let _config = commonConfig[1]
delete(_config['entry']["web-pay-selector"])
delete(_config['entry']["web-index"])
delete(_config['entry']["index"])
delete(_config['entry']["index"])
delete(_config['entry']["pay-old"])
// delete(_config['entry']['translator-workbench-episodes'])

const weexConfig = webpackMerge(_config, {
  watch: true
})
